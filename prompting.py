...
parser = argparse.ArgumentParser(description="set prompting params")
parser.add_argument("--modelname")
parser.add_argument("--adjust_maxlen")
args = parser.parser_args()

if args.modelname:
    modelname = args.modelname
if args.adjust_maxlen:
    adjust_maxlen = args.args.adjust_maxlen
